...
from hermes_memory_evidence_repair.tools.memory_evidence_repair_executor_preview_tool import (
    memory_evidence_repair_executor_preview_tool,
)
from hermes_memory_evidence_repair.tools.memory_evidence_repair_human_approval_token_tool import (
    memory_evidence_repair_human_approval_token_tool,
)
from hermes_memory_evidence_repair.tools.memory_evidence_repair_post_commit_audit_preview_tool import (
...
def test_tool_is_registered_under_memory_toolset():
    ...
    assert entry.toolset == "memory_evidence_repair"
